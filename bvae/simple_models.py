...
class OptimalEncoder(Architecture):
    ...
    def Build(self):
        ...
        net = Conv2D(16, (3, 3), activation='relu', padding='same')(inLayer) #32 filters convolution, 3x3 filter sizes
        net = MaxPooling2D((2, 2), padding='same')(net) #(16,16,3)
        
        net = Conv2D(96, (3, 3), activation='relu', padding='same')(net)
        net = MaxPooling2D((2, 2), padding='same')(net) #(8,8,3)
...
#        net = UpSampling2D((self.inputShape[0]//8, self.inputShape[1]//8))(net)
        ...
        net = Conv2D(96, (3, 3), activation='relu', padding='same')(net) #(8,8,16)
        net = UpSampling2D((2, 2))(net) #(16,16,16)
        net = Conv2D(16, (3, 3), activation='relu', padding='same')(net) #(16,16,32)
